...
export default new VueRouter({
  ...
  routes: [
        { path: '/', component: load('views/dashboard/one/dashboard'), meta: { name: 'Principal' } },
        { path: '/auth', component: load('Auth'), meta: { name: 'Form Login' } },
        { path: '/success', component: load('AuthSuccess'), meta: { name: 'Form Profile' } },
        { path: '/form', component: load('views/form/simpleForm/simpleForm'), meta: { name: 'Cadastrar Nova Inspeção' } },
        { path: '/embeeded', component: load('views/form/embeeded/embeeded'), meta: { name: 'Secretarias' } },
        ...
        { path: '/server-side-data-table', component: load('views/serverSideDataTable/serverSideDataTable'), meta: { name: 'Secretarias' } },
